...
\begin{document}
 % titleslide
    ...
    \begin{frame}[fragile]{Az xcolor csomag alapjai}
        \begin{minipage}{0.8\textwidth}
            \begin{itemize}
                ...
                \end{enumerate}
                Például:
                \item \onslide<5->\verb!\definecolor{szin1}{rgb}{0.500, 0.188, 0.478}! \hfill \fcolorbox{black}{szin1}{ }
                \item \onslide<5->\verb!\definecolor{szin2}{RGB}{196, 203, 133}! \hfill \fcolorbox{black}{szin2}{ }
                \item \onslide<5->\verb!\definecolor{szin3}{cmyk}{0, 0.7771, 0.5437, 0.8656}! \hfill \fcolorbox{black}{szin3}{ }
                \item \onslide<5->\verb!\definecolor{szin4}{gray}{0.5}! \hfill \fcolorbox{black}{szin4}{ }
            \end{itemize}                                                        
        \end{minipage} 
    \end{frame}
    ...
    \begin{frame}[fragile]{Színhalmazok}
        ...
        \end{itemize}
        \onslide<1-> \begin{exampleblock}{Példa: színhalmaz Definiálása}
    ...
    \begin{frame}[fragile]{Színek tesztelése}
        \begin{itemize}
            \item \onslide<1-> A korábban definiált színek tesztelése Különböző módokban.
        \end{itemize}
        \onslide<1->\begin{verbatim}
...
\end{itemize}\end{verbatim}
    ...
    \begin{frame}[fragile]{Példa}
        ...
        \begin{minipage}{0.5\textwidth}
            \begin{itemize}
                \item \onslide<1-> \verb!\definecolorseries{foo}{rgb}{last}{red}{blue}!
                \item \onslide<1-> \verb!\resetcolorseries[8]{foo}!
            \end{itemize}
        ...
        \begin{enumerate}
            \item \onslide<2->\fcolorbox{black}{foo!!+}{ }
            \item \onslide<2->\fcolorbox{black}{foo!!+}{ }
            \item \onslide<2->\fcolorbox{black}{foo!!+}{ }
            \item \onslide<2->\fcolorbox{black}{foo!!+}{ }
            \item \onslide<2->\fcolorbox{black}{foo!!+}{ }
